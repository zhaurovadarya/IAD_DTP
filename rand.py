...
def main():
    ...
    plt.title('Top-20 важных признаков для вида ДТП')
    plt.xlabel('Важность признака', labelpad=15, fontsize=14)
    ...
    sns.barplot(
        ...
        palette='coolwarm')
    plt.title('Top-20 важных признаков для тяжести ДТП')
    plt.xlabel('Важность признака', labelpad=15, fontsize=14)
    plt.ylabel('Признак', labelpad=15, fontsize=14)
    plt.xticks(fontsize=12, rotation=0)
    plt.yticks(fontsize=12)
    ...
    plt.title('Top-20 важных признаков для бинарной тяжести ДТП')
    plt.xlabel('Важность признака', labelpad=15, fontsize=14)
    plt.ylabel('Признак', labelpad=15, fontsize=14)
    plt.xticks(fontsize=12, rotation=0)
    plt.yticks(fontsize=12)
    ...
    if geo_df.empty:
        ...
        plt.yticks(fontsize=12)
        plt.title("Распределение тяжести ДТП по видам", fontsize=14)
        plt.xlabel("Вид ДТП", labelpad=15, fontsize=14)
        plt.ylabel("Тяжесть", labelpad=15, fontsize=14)
        plt.tight_layout()
        ...
        plt.yticks(fontsize=12)
        plt.title("Средняя тяжесть ДТП по районам г.Новосибирска", fontsize=14)
        plt.ylabel("Средняя тяжесть", labelpad=15, fontsize=14)
        plt.xlabel("Район", labelpad=15, fontsize=14)
        plt.tight_layout()
        ...
        plt.xticks(rotation=45, ha='right', fontsize=12)
        plt.yticks(fontsize=12)
        plt.title("Топ-10 районов Новосибирской области по средней тяжести ДТП", fontsize=14)
        plt.ylabel("Средняя тяжесть", labelpad=15, fontsize=14)
        plt.xlabel("Район", labelpad=15, fontsize=14)
        plt.tight_layout()
