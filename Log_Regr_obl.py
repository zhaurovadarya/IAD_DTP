...
def main():
    ...
    print("\nОтчет по классификации для областных наблюдений:")
    ...
    plt.title('ROC Curve для областных наблюдений', fontsize=16)
    ...
    plt.title('Диаграмма распределения предсказанных вероятностей ДТП по областным наблюдениям', fontsize=16)
    plt.xticks(fontsize=14)
    plt.yticks(fontsize=14)
    plt.grid(alpha=0.3)
    plt.tight_layout()
